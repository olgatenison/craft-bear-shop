...
export default async function ProductPage({
  ...
  const productNumericId = product.id.split("/").pop()!; // Shopify ID
  const reviews = await getReviews(productNumericId); // ✅ Используем новую функцию
...
// import Breadcrumbs from "@/app/components/ui/Breadcrumbs";
// import CustomerReviews from "@/app/components/CustomerReviews";
// import { getJudgeMeReviews } from "@/app/lib/judgeme";
...
//   const productNumericId = product.id.split("/").pop()!; // Shopify ID
//   const reviews = await getJudgeMeReviews(productNumericId);
